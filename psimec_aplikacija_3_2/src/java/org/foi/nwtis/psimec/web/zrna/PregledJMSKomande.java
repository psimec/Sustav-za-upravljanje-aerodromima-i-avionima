...
import static org.foi.nwtis.psimec.ejb.mdb.PrimateljPorukaKomandi.slusacKomandi;
...
@Named(value = "pregledJMSKomande")
@SessionScoped
public class PregledJMSKomande implements Serializable {

    @EJB
    private CentarPoruka centarPoruka;

    private String korime;
    private List<KomandaPoruka> listaPorukaKomande;
    ...
    public void osvjeziPoruke() {
        listaPorukaKomande = getListaPorukaKomande();
    ...
    public List<KomandaPoruka> getListaPorukaKomande() {
        listaPorukaKomande = new ArrayList();
        for (KomandaPoruka komandaPoruka : centarPoruka.getListaPorukaKomandi()) {
            if (komandaPoruka.getKorime() == null ? korime == null : komandaPoruka.getKorime().equals(korime)) {
                listaPorukaKomande.add(komandaPoruka);
            }
        }
        return listaPorukaKomande;
    }
